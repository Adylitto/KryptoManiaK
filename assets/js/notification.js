...
function notification() {
    spop({
        template: '<div class="sale_notification d-flex align-items-center"><img src="" alt="" /> <div class="notification_inner"> <h3>'+Math.floor(Math.random()*60000 + 3000)+' KMK</h3><p>Sold in <img src="assets/images/'+countries[Math.floor(Math.random()*7)]+'.png" alt="" /></p></div></div>',
        group: 'submit-satus',
